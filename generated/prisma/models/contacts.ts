...
export type contactsGetPayload<S extends boolean | null | undefined | contactsDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, contactsGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetContactsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
